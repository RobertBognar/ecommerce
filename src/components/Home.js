    ...
    return (
        <div className="container">
            ...
            <div className="image">
                ...
                <a onClick={props.addBasket} className="addToCart cart5" href="#">Add To Cart</a>
            </div>
            <div className="image">
                ...
                <a onClick={props.addBasket} className="addToCart cart6" href="#">Add To Cart</a>
            </div>
            <div className="image">
                ...
                <a onClick={props.addBasket} className="addToCart cart7" href="#">Add To Cart</a>
            </div>
            <div className="image">
                ...
                <a onClick={props.addBasket} className="addToCart cart8" href="#">Add To Cart</a>
            </div>
        </div>
    );
}
